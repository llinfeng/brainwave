...
const whisperUploadButton = document.getElementById('whisperUploadButton');
...
fileInput.onchange = async (event) => {
    ...
    try {
        ...
        uploadButton.textContent = 'Upload (Realtime)';
...
whisperFileInput.onchange = async (event) => {
    const file = event.target.files[0];
    if (!file) return;
    ...
    try {
        ...
        // Update button text to show processing
        whisperUploadButton.textContent = 'Processing...';
        whisperUploadButton.disabled = true;
